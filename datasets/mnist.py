...
class MNIST_AL_Dataset:
    def __init__(self, X_train, Y_train, X_test, Y_test):
        ...
        self.labeled_idx= np.zeros(self.n_pool, dtype=bool)
    
    def initiliazing_labels(self, num):
    ...
    def get_train_data(self):
        return self.dataset(self.X_train, self.Y_train)
    
def get_mnist_al_dataset():
    ...
    return MNIST_AL_Dataset(X_train, Y_train, X_test, Y_test)